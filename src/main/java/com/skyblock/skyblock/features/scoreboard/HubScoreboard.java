...
public class HubScoreboard extends Scoreboard {
    ...
    void display() {
        ...
        if (player.getWorld().getName().startsWith(SkyblockIsland.ISLAND_PREFIX)) loc = ChatColor.GREEN + "Private Island";
        ...
        addLine(9 + offset, ChatColor.GRAY + "" + date + ChatColor.DARK_GRAY + " mini01A");
        ...
        addLine(1, ChatColor.YELLOW + "mc.godspunky.in");
    }
}
