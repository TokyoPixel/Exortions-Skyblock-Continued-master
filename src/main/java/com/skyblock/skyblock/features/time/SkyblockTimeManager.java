...
public class SkyblockTimeManager {
    ...
    public void updateEvents() {
        ...
        if (season.equals("fall") && day >= 30) {
            activeEvents.add("Spooky Festival");
        } else if (season.equals("winter") && (day == 25 || day == 26)) {
            activeEvents.add("Season of Jerry");
        } else if ((season.equals("summer") && (day == 2 || day == 3)) || (season.equals("winter") && (day == 2 || day == 3))) {
            activeEvents.add("Traveling Zoo");
        } else if (season.equals("winter") && (day == 31)) {
            activeEvents.add("New Year Cake Event");
        } else if (season.equals("winter") && (day == 1)) {
            activeEvents.add("Jerry Workshop Open");
        }

        if (!prev.equals(activeEvents)) {
            Bukkit.broadcastMessage(ChatColor.YELLOW + "[Event Manager] Epicportal: " +ChatColor.WHITE + "NEW EVENT STARTED, ACTIVE EVENTS: " + ChatColor.GREEN + activeEvents);
        }
    }
